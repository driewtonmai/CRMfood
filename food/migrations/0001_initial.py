# Generated by Django 2.2.7 on 2019-11-24 10:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='Name')),
                ('departmentid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MealCategories', to='food.Departments', verbose_name='DemartmentID')),
            ],
        ),
        migrations.CreateModel(
            name='Meals',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.IntegerField(choices=[(1, 'to-do'), (2, 'in progress'), (3, 'done')], verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            name='Tables',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login', models.CharField(max_length=50, verbose_name='Name')),
