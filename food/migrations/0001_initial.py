# Generated by Django 2.2.7 on 2019-12-10 09:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tablename', models.IntegerField(choices=[('Table #1', 'Table #1'), ('Table #2', 'Table #2'), ('Table #3', 'Table #3'), ('Table #4', 'Table #4'), ('Table #5', 'Table #5')], verbose_name='Number of table')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roleid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_user_token', to='food.Roles', verbose_name='RoleID')),
            ],
        ),
        migrations.CreateModel(
            name='Checks',
